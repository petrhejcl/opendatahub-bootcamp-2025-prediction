...
#
#
# # Predict future availability for custom date and time
...
#
#
# def parse_prediction_time(time_str):
#     """Parse a user-input date string into a datetime object"""
#     try:
#         # Try different formats
#         formats = [
#             "%Y-%m-%d %H:%M",  # 2023-04-15 14:30
#             "%Y-%m-%d %H:%M:%S",  # 2023-04-15 14:30:00
#             "%d/%m/%Y %H:%M",  # 15/04/2023 14:30
#             "%m/%d/%Y %H:%M",  # 04/15/2023 14:30
#             "%Y-%m-%d",  # 2023-04-15 (will default to 00:00)
#             "%d/%m/%Y",  # 15/04/2023 (will default to 00:00)
#             "%m/%d/%Y"  # 04/15/2023 (will default to 00:00)
#         ]
#
#         for fmt in formats:
#             try:
...
#     except:
#         print(f"Error: Could not parse '{time_str}' as a date. Using current time plus 1 hour.")
...
#         prediction_time = parse_prediction_time(prediction_time_str)
#         print(f"\nMaking prediction for specified time: {prediction_time}")
#     else:
